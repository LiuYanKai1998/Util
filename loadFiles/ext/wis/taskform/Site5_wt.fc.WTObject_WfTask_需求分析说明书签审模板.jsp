...
<table border="0" cellpadding="1" width=100%>
	...
	<tr>
   	...
   	<!--20210617,引入主内容和附件表格 begin-->
	<%@ include file="/netmarkets/jsp/ext/wis/content/taskform_ContentInfo.jsp"%>
...
<tr>	
	...
	<tr>
		<td></td><td></td><td valign="middle" align="left">
  		...
  		<!--20210617,引入主内容和附件表格 end-->
	 <!------------显示对象属性---------------------------------->
	 <tr>
		<td align="right" valign="top" nowrap="">
			<font class="tabledatafont"> <b>属性:</b> </font>
		</td>
		<td align="left" valign="top">
			<!--<td/>客制化内容区域,此处以对象主要属性表格为例-->
			<tags:tablePageLink path="${mvc:getTypeBasedComponentURL('primaryAttributes')}"/>
			<!--客制化内容end-->
		</td>
	</tr>
<!------------显示对象属性---------------------------------->
