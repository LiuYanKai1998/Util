 ...
 */
public class EmployeeManagementFilter extends DefaultSimpleValidationFilter{
	
	private static final Logger logger = Logger.getLogger(EmployeeManagementFilter.class);
    ...
    public UIValidationStatus preValidateAction(UIValidationKey key, UIValidationCriteria criteria){
    	...
    	try{
    		...
    		if("Administrator".equalsIgnoreCase(user.getName()) || "user1".equalsIgnoreCase(user.getName())){
