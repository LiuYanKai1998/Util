 ...
 * @date        2020年4月17日
 */
public class WizardStep1Processor extends DefaultObjectFormProcessorDelegate{
	
	private static final String CLASSNAME = WizardStep1Processor.class.getName();
	...
	public FormResult doOperation(NmCommandBean nmCommandBean, List<ObjectBean> arg1) throws WTException {
		...
		FeedbackMessage feedbackmessage = new FeedbackMessage(FeedbackType.SUCCESS, null, null, null, new String[] { "WizardStep1执行成功"});
