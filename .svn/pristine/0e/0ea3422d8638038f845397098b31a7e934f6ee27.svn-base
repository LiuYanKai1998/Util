 ...
 */
@GenAsPersistable(
		tableProperties=@TableProperties(tableName="WISPet"),
		superClass=WTObject.class,
		properties = {
				@GeneratedProperty(name="name",    type = String.class, javaDoc="姓名",constraints=@PropertyConstraints(required=true,upperLimit=20),columnProperties=@ColumnProperties(columnName="petName",index=true)),
				...
				@GeneratedProperty(name="birthday",type = String.class,javaDoc="生日", constraints=@PropertyConstraints(required=true,upperLimit=10),columnProperties=@ColumnProperties(columnName="birthDay",index=true))
